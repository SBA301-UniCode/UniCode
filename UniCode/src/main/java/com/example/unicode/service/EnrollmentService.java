...
public interface EnrollmentService {
    ...
    boolean isbanned(EnrollementBannerRequest request);

    void banLearner(EnrollementBannerRequest request,boolean ban);

    Page<EnrollmentReportResponse> getReportEnrollmentFollowByCourse(UUID coureId, String keySearch,boolean banned,int page, int size);
}
